      ...
      <ul class="space-y-4 cl">
        ...
        <li>
          <ul class="aside -mt-8">
            <li class="aside">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStlwNGthcr4E9C7-WM7IyoD4kUN2uDIsqk0w&usqp=CAU"
                alt=""
                class="aside mt-8"
              />
              <div class="aside -mt-12">
                <h2 class="aside">User 2</h2>
                <h3 class="aside">
                  <span class="status green"></span>
                  online
                </h3>
        ...
        <li>
          <ul class="aside -mt-8">
            <li class="aside">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_q8BTSR6jj42rLZCG6KaiD9KrNWHwpZje2g&usqp=CAU"
                alt=""
                class="aside mt-8"
              />
              <div class="aside -mt-12">
                <h2 class="aside">User 3</h2>
                <h3 class="aside">
        ...
        <li>
          <ul class="aside -mt-8">
            <li class="aside">
              <img
                src="https://i.pinimg.com/originals/bd/2c/e7/bd2ce788043f7c1b3d66466c4a8f6bee.png"
                alt=""
                class="aside mt-8"
              />
              <div class="aside -mt-12">
                <h2 class="aside">User 5</h2>
                <h3 class="aside">
                  <span class="status green"></span>
                  online
                </h3>
    ...
    <div class="w-4/5">
      ...
      <div class="flex">
        ...
        <div class="1/5 h-screen body-bg3">
          ...
          />
          <h1 class="mt-4 text-xl font-mono">Hadhémi Gharbi</h1>
          <h3 class="aside">
            <span class="status green"></span>
            Online
          </h3>
          <h2 class="font-mono mt-2">hadhemigharbi123@gmail.com</h2>
          <button
